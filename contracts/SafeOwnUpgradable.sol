...
abstract contract SafeOwnUpgradable is Initializable {
     ...
     */
    function __SafeOwn_init(uint256 renounceInterval) internal onlyInitializing {
        __SafeOwn_init_unchained(renounceInterval);
    }

    function __SafeOwn_init_unchained(uint256 renounceInterval) internal onlyInitializing {
        _Owner = msg.sender;
